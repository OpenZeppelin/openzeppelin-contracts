...
* `ERC20`: Removing the `_setDecimals` functions and the storage slot associated to decimals. ([#2502](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/2502))
