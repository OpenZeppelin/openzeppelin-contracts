 ...
 * `Crowdsale`: the constructor is now `public`, meaning standalone `Crowdsales` can be deployed. ([#1564](https://github.com/OpenZeppelin/openzeppelin-solidity/pull/1564))
