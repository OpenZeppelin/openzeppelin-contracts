...
## Unreleased
 * `ERC20LockerContract`: Added new ERC20 contract, aiming to distribute pre-defined ERC20 tokens to the owner wallet. ([#3795](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/3795))
