 ...
 * `ERC20Votes`: This contract will not inherit from `ERC20Permit`, it have its own nonces for delegation and direct inheritance from EIP712. [#](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/)
 ...
 * `Nonces`: This is a new contract to keep track of nonces and substitute the `_nonces` storage variable inside `Votes` contract. ([#](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/#))
