 ...
 * `EIP5805`: The `EIP5805` is the standard EIP for what used to be the `Votes` contract, Now it will be used in all the contracts where `Votes` used to be imported. ([#3638](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/3638))
