 ...
 * `EnumerableMap`: Use `EnumerableSet` for key management, in order to optimize for `key → value` lookups instead of `index → value` lookups. ([#2518](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/2518))
