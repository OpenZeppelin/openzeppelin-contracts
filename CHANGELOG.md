 ...
 * `GovernorCountingSimple`: rename `proposalvote` variables to `proposalVote` to preserve camelCase. ([#3608](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/3608))
### Compatibility Note
