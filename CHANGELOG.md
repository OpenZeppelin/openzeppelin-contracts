 ...
 * `MerkleProof`: add `multiProofVerify` to prove multiple values are part of a Merkle tree. ([#3108](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/3108))
