...
- `ERC777`: The `ERC777` token standard is no longer supported by OpenZeppelin. Our implementation is now deprecated and will be removed in the next major release. The corresponding stardard interfaces remain available. ([#](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/))
- `ERC1820Implementer`: The `ERC1820` pseudo-introspection mechanism is no longer supported by OpenZeppelin. Our implementation is now deprecated and will be removed in the next major release. The corresponding stardard interfaces remain available. ([#](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/))
