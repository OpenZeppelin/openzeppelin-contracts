...
- [BREAKING] `ERC2771Forwarder`: custom error `ERC2771ForwarderFailureInAtomicBatch` has been renamed to `ERC2771ForwarderNoRefundReceiver` ([#6615](https://github.com/OpenZeppelin/openzeppelin-contracts/pull/6615))
