...
```solidity
include::api:example$MyTokenGovernance1.sol[]
```
...
```solidity
include::api:example$MyTokenGovernance2.sol[]
```
...
```solidity
include::api:example$MyGovernor.sol[]
```
...
```solidity
include::api:example$MyTokenGovernance3.sol[]
```
