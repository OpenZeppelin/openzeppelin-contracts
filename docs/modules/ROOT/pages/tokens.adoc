...
* xref:erc1363.adoc[ERC1363]: ERC20 compatible tokens that can perform a callback on a receiver or spender contract, after a transfer or an approval, in a single transaction.
