...
* A successful xref:api:token/ERC20.adoc#IERC20-transfer-address-uint256-[`transfer`] or xref:api:token/ERC20.adoc#IERC20-transferFrom-address-address-uint256-[`transferFrom`] of `amount` increases the recipient's xref:api:token/ERC20.adoc#IERC20-balanceOf-address-[`balanceOf`] by exactly `amount`.
