...
[stem]
++++
\text{loss} \approx \frac{a_1}{1 + a_0} - \frac{a_0 \times u}{1 + a_0}
++++
...
[stem]
++++
\iff 10^\delta \times u - \frac{a_0 \times u}{1 + a_0} \le \mathit{loss}
++++

[stem]
++++
\iff 10^\delta \times u \times (1 - \frac{a_0}{1 + a_0}) \le \mathit{loss}
++++
