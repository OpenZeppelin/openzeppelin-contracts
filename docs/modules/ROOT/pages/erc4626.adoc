...
In this scenario, the attack is stem:[n] times less powerful (in how much it is stealing) and cost stem:[n] times less to execute. In both cases, the amount of fund the attacker needs to commit is equivalent to its potential winnings.
