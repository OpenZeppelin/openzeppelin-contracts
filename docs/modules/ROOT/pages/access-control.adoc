...
Although xref:api:access.adoc#AccessControl[`AccessControl`] offers a more dynamic solution for permissioning your contracts, decentralized protocols tend become more complex after integrating new contract instances, requiring to keep track permissions in each one. This increases complexity of uniformly monitoring and updating permissions across the system.
