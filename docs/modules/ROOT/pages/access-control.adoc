...
* {AccessManagerEnumerable-getRoleMemberCount}
* {AccessManagerEnumerable-getRoleMember}
* {AccessManagerEnumerable-getRoleMembers}

And these functions for target function permissions:

* {AccessManagerEnumerable-getRoleTargetFunctionCount}
* {AccessManagerEnumerable-getRoleTargetFunction}
* {AccessManagerEnumerable-getRoleTargetFunctions}
