...
:xref-GovernorVotesComp-clock--: xref:governance.adoc#GovernorVotesComp-clock--
:xref-GovernorVotesComp-CLOCK_MODE--: xref:governance.adoc#GovernorVotesComp-CLOCK_MODE--
...
:xref-GovernorCompatibilityBravo-cancel-address---uint256---bytes---bytes32-: xref:governance.adoc#GovernorCompatibilityBravo-cancel-address---uint256---bytes---bytes32-
...
:clock: pass:normal[xref:#IGovernor-clock--[`++clock++`]]
:CLOCK_MODE: pass:normal[xref:#IGovernor-CLOCK_MODE--[`++CLOCK_MODE++`]]
...
[.contract]
[[IGovernor]]
=== `++IGovernor++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/IGovernor.sol[{github-icon},role=heading-link]
...
* {xref-IGovernor-clock--}[`++clock()++`]
* {xref-IGovernor-CLOCK_MODE--}[`++CLOCK_MODE()++`]
...
==== `[.contract-item-name]#++cancel++#++(address[] targets, uint256[] values, bytes[] calldatas, bytes32 descriptionHash) → uint256 proposalId++` [.item-kind]#public#
...
[.contract]
[[Governor]]
=== `++Governor++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/Governor.sol[{github-icon},role=heading-link]
...
=== `++GovernorCountingSimple++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorCountingSimple.sol[{github-icon},role=heading-link]
...
:token: pass:normal[xref:#GovernorVotes-token-contract-IERC5805[`++token++`]]
...
[.contract]
[[GovernorVotes]]
=== `++GovernorVotes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorVotes.sol[{github-icon},role=heading-link]
...
=== `++GovernorVotesQuorumFraction++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorVotesQuorumFraction.sol[{github-icon},role=heading-link]
...
:clock: pass:normal[xref:#GovernorVotesComp-clock--[`++clock++`]]
:CLOCK_MODE: pass:normal[xref:#GovernorVotesComp-CLOCK_MODE--[`++CLOCK_MODE++`]]
:_getVotes: pass:normal[xref:#GovernorVotesComp-_getVotes-address-uint256-bytes-[`++_getVotes++`]]

[.contract]
[[GovernorVotesComp]]
=== `++GovernorVotesComp++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorVotesComp.sol[{github-icon},role=heading-link]
...
* {xref-GovernorVotesComp-clock--}[`++clock()++`]
* {xref-GovernorVotesComp-CLOCK_MODE--}[`++CLOCK_MODE()++`]
* {xref-GovernorVotesComp-_getVotes-address-uint256-bytes-}[`++_getVotes(account, timepoint, )++`]
...
=== `++GovernorTimelockControl++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorTimelockControl.sol[{github-icon},role=heading-link]
...
=== `++GovernorTimelockCompound++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorTimelockCompound.sol[{github-icon},role=heading-link]
...
[.contract]
[[GovernorSettings]]
=== `++GovernorSettings++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorSettings.sol[{github-icon},role=heading-link]
...
=== `++GovernorPreventLateQuorum++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorPreventLateQuorum.sol[{github-icon},role=heading-link]
...
:cancel: pass:normal[xref:#GovernorCompatibilityBravo-cancel-address---uint256---bytes---bytes32-[`++cancel++`]]
...
=== `++GovernorCompatibilityBravo++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/compatibility/GovernorCompatibilityBravo.sol[{github-icon},role=heading-link]
...
* {xref-GovernorCompatibilityBravo-cancel-address---uint256---bytes---bytes32-}[`++cancel(targets, values, calldatas, descriptionHash)++`]
...
[.contract-item]
[[GovernorCompatibilityBravo-cancel-address---uint256---bytes---bytes32-]]
==== `[.contract-item-name]#++cancel++#++(address[] targets, uint256[] values, bytes[] calldatas, bytes32 descriptionHash) → uint256++` [.item-kind]#public#
...
=== `++GovernorProposalThreshold++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/extensions/GovernorProposalThreshold.sol[{github-icon},role=heading-link]
...
[.contract]
[[Votes]]
=== `++Votes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/utils/Votes.sol[{github-icon},role=heading-link]
...
[.contract]
[[TimelockController]]
=== `++TimelockController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.1/contracts/governance/TimelockController.sol[{github-icon},role=heading-link]
