...
:Governor: pass:normal[xref:governance.adoc#Governor[`Governor`]]
:GovernorSequentialProposalId: pass:normal[xref:governance.adoc#GovernorSequentialProposalId[`GovernorSequentialProposalId`]]
:Governor: pass:normal[xref:governance.adoc#Governor[`Governor`]]
...
:xref-IGovernor-GovernorProposalQueueingNotRequired-uint256-: xref:governance.adoc#IGovernor-GovernorProposalQueueingNotRequired-uint256-
:xref-IGovernor-GovernorProposalQueueingFailed-uint256-: xref:governance.adoc#IGovernor-GovernorProposalQueueingFailed-uint256-
...
:xref-GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-: xref:governance.adoc#GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-
:xref-GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-: xref:governance.adoc#GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-
:xref-Governor-receive--: xref:governance.adoc#Governor-receive--
:xref-Governor-supportsInterface-bytes4-: xref:governance.adoc#Governor-supportsInterface-bytes4-
:xref-Governor-name--: xref:governance.adoc#Governor-name--
:xref-Governor-version--: xref:governance.adoc#Governor-version--
...
:xref-GovernorPreventLateQuorum-_maxLateQuorumVoteExtension--: xref:governance.adoc#GovernorPreventLateQuorum-_maxLateQuorumVoteExtension--
...
:xref-IGovernor-VoteCastWithParams-address-uint256-uint8-uint256-string-bytes-: xref:governance.adoc#IGovernor-VoteCastWithParams-address-uint256-uint8-uint256-string-bytes-
:xref-IERC5267-EIP712DomainChanged--: xref:interfaces.adoc#IERC5267-EIP712DomainChanged--
:xref-GovernorPreventLateQuorum-GovernorPreventLateQuorumVoteExtensionTooLarge-uint256-uint256-: xref:governance.adoc#GovernorPreventLateQuorum-GovernorPreventLateQuorumVoteExtensionTooLarge-uint256-uint256-
:xref-IGovernor-GovernorInvalidProposalLength-uint256-uint256-uint256-: xref:governance.adoc#IGovernor-GovernorInvalidProposalLength-uint256-uint256-uint256-
:xref-IGovernor-GovernorAlreadyCastVote-address-: xref:governance.adoc#IGovernor-GovernorAlreadyCastVote-address-
:xref-IGovernor-GovernorDisabledDeposit--: xref:governance.adoc#IGovernor-GovernorDisabledDeposit--
:xref-IGovernor-GovernorOnlyExecutor-address-: xref:governance.adoc#IGovernor-GovernorOnlyExecutor-address-
...
:Governor-state: pass:normal[xref:governance.adoc#Governor-state-uint256-[`Governor.state`]]
:Governor: pass:normal[xref:governance.adoc#Governor[`Governor`]]
:xref-GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-: xref:governance.adoc#GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-
:xref-GovernorSequentialProposalId-latestProposalId--: xref:governance.adoc#GovernorSequentialProposalId-latestProposalId--
:xref-GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-: xref:governance.adoc#GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-
:xref-GovernorSequentialProposalId-_initializeLatestProposalId-uint256-: xref:governance.adoc#GovernorSequentialProposalId-_initializeLatestProposalId-uint256-
:xref-Governor-receive--: xref:governance.adoc#Governor-receive--
:xref-Governor-supportsInterface-bytes4-: xref:governance.adoc#Governor-supportsInterface-bytes4-
:xref-Governor-name--: xref:governance.adoc#Governor-name--
:xref-Governor-version--: xref:governance.adoc#Governor-version--
...
:xref-IGovernor-VoteCastWithParams-address-uint256-uint8-uint256-string-bytes-: xref:governance.adoc#IGovernor-VoteCastWithParams-address-uint256-uint8-uint256-string-bytes-
:xref-IERC5267-EIP712DomainChanged--: xref:interfaces.adoc#IERC5267-EIP712DomainChanged--
:xref-GovernorSequentialProposalId-GovernorAlreadyInitializedLatestProposalId--: xref:governance.adoc#GovernorSequentialProposalId-GovernorAlreadyInitializedLatestProposalId--
:xref-IGovernor-GovernorInvalidProposalLength-uint256-uint256-uint256-: xref:governance.adoc#IGovernor-GovernorInvalidProposalLength-uint256-uint256-uint256-
:xref-IGovernor-GovernorAlreadyCastVote-address-: xref:governance.adoc#IGovernor-GovernorAlreadyCastVote-address-
:xref-IGovernor-GovernorDisabledDeposit--: xref:governance.adoc#IGovernor-GovernorDisabledDeposit--
:xref-IGovernor-GovernorOnlyExecutor-address-: xref:governance.adoc#IGovernor-GovernorOnlyExecutor-address-
...
:GovernorProposalQueueingNotRequired: pass:normal[xref:#IGovernor-GovernorProposalQueueingNotRequired-uint256-[`++GovernorProposalQueueingNotRequired++`]]
:GovernorProposalQueueingFailed: pass:normal[xref:#IGovernor-GovernorProposalQueueingFailed-uint256-[`++GovernorProposalQueueingFailed++`]]
...
[.contract]
[[IGovernor]]
=== `++IGovernor++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/IGovernor.sol[{github-icon},role=heading-link]
...
* {xref-IGovernor-GovernorProposalQueueingNotRequired-uint256-}[`++GovernorProposalQueueingNotRequired(proposalId)++`]
* {xref-IGovernor-GovernorProposalQueueingFailed-uint256-}[`++GovernorProposalQueueingFailed(proposalId)++`]
...
[.contract-item]
[[IGovernor-GovernorProposalQueueingNotRequired-uint256-]]
==== `[.contract-item-name]#++GovernorProposalQueueingNotRequired++#++(uint256 proposalId)++` [.item-kind]#error#

This operation doesn't require queuing and should be executed directly.

[.contract-item]
[[IGovernor-GovernorProposalQueueingFailed-uint256-]]
==== `[.contract-item-name]#++GovernorProposalQueueingFailed++#++(uint256 proposalId)++` [.item-kind]#error#

Indicates a misconfigured timelock module. (e.g. {_queueOperations} returned a zero ETA)
...
[.contract]
[[Governor]]
=== `++Governor++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/Governor.sol[{github-icon},role=heading-link]
...
=== `++GovernorCountingSimple++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorCountingSimple.sol[{github-icon},role=heading-link]
...
=== `++GovernorCountingFractional++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorCountingFractional.sol[{github-icon},role=heading-link]
...
=== `++GovernorCountingOverridable++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorCountingOverridable.sol[{github-icon},role=heading-link]
...
[.contract]
[[GovernorVotes]]
=== `++GovernorVotes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorVotes.sol[{github-icon},role=heading-link]
...
=== `++GovernorVotesQuorumFraction++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorVotesQuorumFraction.sol[{github-icon},role=heading-link]
...
=== `++GovernorVotesSuperQuorumFraction++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorVotesSuperQuorumFraction.sol[{github-icon},role=heading-link]
...
=== `++GovernorTimelockAccess++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorTimelockAccess.sol[{github-icon},role=heading-link]
...
=== `++GovernorTimelockControl++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorTimelockControl.sol[{github-icon},role=heading-link]
...
=== `++GovernorTimelockCompound++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorTimelockCompound.sol[{github-icon},role=heading-link]
...
:relayCrosschain: pass:normal[xref:#GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-[`++relayCrosschain++`]]
:_crosschainExecute: pass:normal[xref:#GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-[`++_crosschainExecute++`]]

:relayCrosschain-address-bytes-Mode-bytes: pass:normal[xref:#GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-[`++relayCrosschain++`]]
:_crosschainExecute-address-bytes-Mode-bytes: pass:normal[xref:#GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-[`++_crosschainExecute++`]]

[.contract]
[[GovernorCrosschain]]
=== `++GovernorCrosschain++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorCrosschain.sol[{github-icon},role=heading-link]
...
Extension of {Governor} for cross-chain governance through ERC-7786 gateways and {CrosschainRemoteExecutor}.

[.contract-index]
.Functions
--
* {xref-GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-}[`++relayCrosschain(gateway, executor, mode, executionCalldata)++`]
* {xref-GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-}[`++_crosschainExecute(gateway, executor, mode, executionCalldata)++`]
...
[.contract-item]
[[GovernorCrosschain-relayCrosschain-address-bytes-Mode-bytes-]]
==== `[.contract-item-name]#++relayCrosschain++#++(address gateway, bytes executor, Mode mode, bytes executionCalldata)++` [.item-kind]#public#

Send crosschain instruction to an arbitrary remote executor via an arbitrary ERC-7786 gateway.

[.contract-item]
[[GovernorCrosschain-_crosschainExecute-address-bytes-Mode-bytes-]]
==== `[.contract-item-name]#++_crosschainExecute++#++(address gateway, bytes executor, Mode mode, bytes executionCalldata)++` [.item-kind]#internal#
...
[.contract]
[[GovernorNoncesKeyed]]
=== `++GovernorNoncesKeyed++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorNoncesKeyed.sol[{github-icon},role=heading-link]
...
:GovernorPreventLateQuorumVoteExtensionTooLarge: pass:normal[xref:#GovernorPreventLateQuorum-GovernorPreventLateQuorumVoteExtensionTooLarge-uint256-uint256-[`++GovernorPreventLateQuorumVoteExtensionTooLarge++`]]
...
:_maxLateQuorumVoteExtension: pass:normal[xref:#GovernorPreventLateQuorum-_maxLateQuorumVoteExtension--[`++_maxLateQuorumVoteExtension++`]]
...
=== `++GovernorPreventLateQuorum++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorPreventLateQuorum.sol[{github-icon},role=heading-link]
...
* {xref-GovernorPreventLateQuorum-_maxLateQuorumVoteExtension--}[`++_maxLateQuorumVoteExtension()++`]
...
.Errors
--
* {xref-GovernorPreventLateQuorum-GovernorPreventLateQuorumVoteExtensionTooLarge-uint256-uint256-}[`++GovernorPreventLateQuorumVoteExtensionTooLarge(newVoteExtension, maxVoteExtension)++`]
...
[.contract-item]
[[GovernorPreventLateQuorum-_maxLateQuorumVoteExtension--]]
==== `[.contract-item-name]#++_maxLateQuorumVoteExtension++#++() → uint256++` [.item-kind]#internal#

Upper bound applied to {lateQuorumVoteExtension} when it is set. Defaults to the voting period,
...
[.contract-item]
[[GovernorPreventLateQuorum-GovernorPreventLateQuorumVoteExtensionTooLarge-uint256-uint256-]]
==== `[.contract-item-name]#++GovernorPreventLateQuorumVoteExtensionTooLarge++#++(uint256 newVoteExtension, uint256 maxVoteExtension)++` [.item-kind]#error#

Thrown when the {lateQuorumVoteExtension} parameter is set to a value larger than {_maxLateQuorumVoteExtension}.
...
=== `++GovernorProposalGuardian++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorProposalGuardian.sol[{github-icon},role=heading-link]
...
[.contract]
[[GovernorSettings]]
=== `++GovernorSettings++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorSettings.sol[{github-icon},role=heading-link]
...
[.contract]
[[GovernorStorage]]
=== `++GovernorStorage++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorStorage.sol[{github-icon},role=heading-link]
...
[.contract]
[[GovernorSuperQuorum]]
=== `++GovernorSuperQuorum++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorSuperQuorum.sol[{github-icon},role=heading-link]
...
:GovernorAlreadyInitializedLatestProposalId: pass:normal[xref:#GovernorSequentialProposalId-GovernorAlreadyInitializedLatestProposalId--[`++GovernorAlreadyInitializedLatestProposalId++`]]
:getProposalId: pass:normal[xref:#GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-[`++getProposalId++`]]
:latestProposalId: pass:normal[xref:#GovernorSequentialProposalId-latestProposalId--[`++latestProposalId++`]]
:_propose: pass:normal[xref:#GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-[`++_propose++`]]
:_initializeLatestProposalId: pass:normal[xref:#GovernorSequentialProposalId-_initializeLatestProposalId-uint256-[`++_initializeLatestProposalId++`]]

:getProposalId-address---uint256---bytes---bytes32: pass:normal[xref:#GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-[`++getProposalId++`]]
:latestProposalId-: pass:normal[xref:#GovernorSequentialProposalId-latestProposalId--[`++latestProposalId++`]]
:_propose-address---uint256---bytes---string-address: pass:normal[xref:#GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-[`++_propose++`]]
:_initializeLatestProposalId-uint256: pass:normal[xref:#GovernorSequentialProposalId-_initializeLatestProposalId-uint256-[`++_initializeLatestProposalId++`]]

[.contract]
[[GovernorSequentialProposalId]]
=== `++GovernorSequentialProposalId++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/extensions/GovernorSequentialProposalId.sol[{github-icon},role=heading-link]
...
Extension of {Governor} that changes the numbering of proposal ids from the default hash-based approach to
sequential ids.

[.contract-index]
.Functions
--
* {xref-GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-}[`++getProposalId(targets, values, calldatas, descriptionHash)++`]
* {xref-GovernorSequentialProposalId-latestProposalId--}[`++latestProposalId()++`]
* {xref-GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-}[`++_propose(targets, values, calldatas, description, proposer)++`]
* {xref-GovernorSequentialProposalId-_initializeLatestProposalId-uint256-}[`++_initializeLatestProposalId(newLatestProposalId)++`]
...
.Errors
--
* {xref-GovernorSequentialProposalId-GovernorAlreadyInitializedLatestProposalId--}[`++GovernorAlreadyInitializedLatestProposalId()++`]
...
[.contract-item]
[[GovernorSequentialProposalId-getProposalId-address---uint256---bytes---bytes32-]]
==== `[.contract-item-name]#++getProposalId++#++(address[] targets, uint256[] values, bytes[] calldatas, bytes32 descriptionHash) → uint256++` [.item-kind]#public#

[.contract-item]
[[GovernorSequentialProposalId-latestProposalId--]]
==== `[.contract-item-name]#++latestProposalId++#++() → uint256++` [.item-kind]#public#

Returns the latest proposal id. A return value of 0 means no proposals have been created yet.

[.contract-item]
[[GovernorSequentialProposalId-_propose-address---uint256---bytes---string-address-]]
==== `[.contract-item-name]#++_propose++#++(address[] targets, uint256[] values, bytes[] calldatas, string description, address proposer) → uint256++` [.item-kind]#internal#
...
[.contract-item]
[[GovernorSequentialProposalId-_initializeLatestProposalId-uint256-]]
==== `[.contract-item-name]#++_initializeLatestProposalId++#++(uint256 newLatestProposalId)++` [.item-kind]#internal#
...
[.contract-item]
[[GovernorSequentialProposalId-GovernorAlreadyInitializedLatestProposalId--]]
==== `[.contract-item-name]#++GovernorAlreadyInitializedLatestProposalId++#++()++` [.item-kind]#error#

The {latestProposalId} may only be initialized if it hasn't been set yet
(through initialization or the creation of a proposal).

== Utils

:VotesExpiredSignature: pass:normal[xref:#IVotes-VotesExpiredSignature-uint256-[`++VotesExpiredSignature++`]]
:DelegateChanged: pass:normal[xref:#IVotes-DelegateChanged-address-address-address-[`++DelegateChanged++`]]
:DelegateVotesChanged: pass:normal[xref:#IVotes-DelegateVotesChanged-address-uint256-uint256-[`++DelegateVotesChanged++`]]
:getVotes: pass:normal[xref:#IVotes-getVotes-address-[`++getVotes++`]]
:getPastVotes: pass:normal[xref:#IVotes-getPastVotes-address-uint256-[`++getPastVotes++`]]
:getPastTotalSupply: pass:normal[xref:#IVotes-getPastTotalSupply-uint256-[`++getPastTotalSupply++`]]
:delegates: pass:normal[xref:#IVotes-delegates-address-[`++delegates++`]]
:delegate: pass:normal[xref:#IVotes-delegate-address-[`++delegate++`]]
:delegateBySig: pass:normal[xref:#IVotes-delegateBySig-address-uint256-uint256-uint8-bytes32-bytes32-[`++delegateBySig++`]]

:getVotes-address: pass:normal[xref:#IVotes-getVotes-address-[`++getVotes++`]]
:getPastVotes-address-uint256: pass:normal[xref:#IVotes-getPastVotes-address-uint256-[`++getPastVotes++`]]
:getPastTotalSupply-uint256: pass:normal[xref:#IVotes-getPastTotalSupply-uint256-[`++getPastTotalSupply++`]]
:delegates-address: pass:normal[xref:#IVotes-delegates-address-[`++delegates++`]]
:delegate-address: pass:normal[xref:#IVotes-delegate-address-[`++delegate++`]]
:delegateBySig-address-uint256-uint256-uint8-bytes32-bytes32: pass:normal[xref:#IVotes-delegateBySig-address-uint256-uint256-uint8-bytes32-bytes32-[`++delegateBySig++`]]

[.contract]
[[IVotes]]
=== `++IVotes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/utils/IVotes.sol[{github-icon},role=heading-link]
...
[.contract-item]
[[IVotes-getVotes-address-]]
==== `[.contract-item-name]#++getVotes++#++(address account) → uint256++` [.item-kind]#external#

Returns the current amount of votes that `account` has.

[.contract-item]
[[IVotes-getPastVotes-address-uint256-]]
==== `[.contract-item-name]#++getPastVotes++#++(address account, uint256 timepoint) → uint256++` [.item-kind]#external#

Returns the amount of votes that `account` had at a specific moment in the past. If the `clock()` is
configured to use block numbers, this will return the value at the end of the corresponding block.

[.contract-item]
[[IVotes-getPastTotalSupply-uint256-]]
==== `[.contract-item-name]#++getPastTotalSupply++#++(uint256 timepoint) → uint256++` [.item-kind]#external#
...
[.contract-item]
[[IVotes-delegates-address-]]
==== `[.contract-item-name]#++delegates++#++(address account) → address++` [.item-kind]#external#

Returns the delegate that `account` has chosen.

[.contract-item]
[[IVotes-delegate-address-]]
==== `[.contract-item-name]#++delegate++#++(address delegatee)++` [.item-kind]#external#

Delegates votes from the sender to `delegatee`.

[.contract-item]
[[IVotes-delegateBySig-address-uint256-uint256-uint8-bytes32-bytes32-]]
==== `[.contract-item-name]#++delegateBySig++#++(address delegatee, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s)++` [.item-kind]#external#

Delegates votes from signer to `delegatee`.

[.contract-item]
[[IVotes-DelegateChanged-address-address-address-]]
...
[.contract-item]
[[IVotes-DelegateVotesChanged-address-uint256-uint256-]]
==== `[.contract-item-name]#++DelegateVotesChanged++#++(address indexed delegate, uint256 previousVotes, uint256 newVotes)++` [.item-kind]#event#

Emitted when a token transfer or delegate change results in changes to a delegate's number of voting units.

[.contract-item]
[[IVotes-VotesExpiredSignature-uint256-]]
...
[.contract]
[[Votes]]
=== `++Votes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/utils/Votes.sol[{github-icon},role=heading-link]
...
==== `[.contract-item-name]#++_checkpoints++#++(address account, uint32 index) → struct Checkpoints.Checkpoint208++` [.item-kind]#internal#
...
[.contract]
[[VotesExtended]]
=== `++VotesExtended++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/utils/VotesExtended.sol[{github-icon},role=heading-link]
...
[.contract]
[[TimelockController]]
=== `++TimelockController++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/governance/TimelockController.sol[{github-icon},role=heading-link]
