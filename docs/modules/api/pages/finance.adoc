...
:VestingWalletCliff: pass:normal[xref:finance.adoc#VestingWalletCliff[`VestingWalletCliff`]]
:VestingWallet: pass:normal[xref:finance.adoc#VestingWallet[`VestingWallet`]]
...
:VestingWallet: pass:normal[xref:finance.adoc#VestingWallet[`VestingWallet`]]
:xref-VestingWalletCliff-constructor-uint64-: xref:finance.adoc#VestingWalletCliff-constructor-uint64-
:xref-VestingWalletCliff-cliff--: xref:finance.adoc#VestingWalletCliff-cliff--
:xref-VestingWalletCliff-_vestingSchedule-uint256-uint64-: xref:finance.adoc#VestingWalletCliff-_vestingSchedule-uint256-uint64-
:xref-VestingWallet-receive--: xref:finance.adoc#VestingWallet-receive--
:xref-VestingWallet-start--: xref:finance.adoc#VestingWallet-start--
:xref-VestingWallet-duration--: xref:finance.adoc#VestingWallet-duration--
:xref-VestingWallet-end--: xref:finance.adoc#VestingWallet-end--
...
:xref-VestingWallet-ERC20Released-address-uint256-: xref:finance.adoc#VestingWallet-ERC20Released-address-uint256-
:xref-Ownable-OwnershipTransferred-address-address-: xref:access.adoc#Ownable-OwnershipTransferred-address-address-
:xref-VestingWalletCliff-InvalidCliffDuration-uint64-uint64-: xref:finance.adoc#VestingWalletCliff-InvalidCliffDuration-uint64-uint64-
:xref-Ownable-OwnableUnauthorizedAccount-address-: xref:access.adoc#Ownable-OwnableUnauthorizedAccount-address-
:xref-Ownable-OwnableInvalidOwner-address-: xref:access.adoc#Ownable-OwnableInvalidOwner-address-
:VestingWallet: pass:normal[xref:finance.adoc#VestingWallet[`VestingWallet`]]
= Finance
...
[.contract]
[[VestingWallet]]
=== `++VestingWallet++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/finance/VestingWallet.sol[{github-icon},role=heading-link]
...
:InvalidCliffDuration: pass:normal[xref:#VestingWalletCliff-InvalidCliffDuration-uint64-uint64-[`++InvalidCliffDuration++`]]
:constructor: pass:normal[xref:#VestingWalletCliff-constructor-uint64-[`++constructor++`]]
:cliff: pass:normal[xref:#VestingWalletCliff-cliff--[`++cliff++`]]
:_vestingSchedule: pass:normal[xref:#VestingWalletCliff-_vestingSchedule-uint256-uint64-[`++_vestingSchedule++`]]

:constructor-uint64: pass:normal[xref:#VestingWalletCliff-constructor-uint64-[`++constructor++`]]
:cliff-: pass:normal[xref:#VestingWalletCliff-cliff--[`++cliff++`]]
:_vestingSchedule-uint256-uint64: pass:normal[xref:#VestingWalletCliff-_vestingSchedule-uint256-uint64-[`++_vestingSchedule++`]]

[.contract]
[[VestingWalletCliff]]
=== `++VestingWalletCliff++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/finance/VestingWalletCliff.sol[{github-icon},role=heading-link]
...
.Functions
--
* {xref-VestingWalletCliff-constructor-uint64-}[`++constructor(cliffSeconds)++`]
* {xref-VestingWalletCliff-cliff--}[`++cliff()++`]
* {xref-VestingWalletCliff-_vestingSchedule-uint256-uint64-}[`++_vestingSchedule(totalAllocation, timestamp)++`]
...
.Errors
--
* {xref-VestingWalletCliff-InvalidCliffDuration-uint64-uint64-}[`++InvalidCliffDuration(cliffSeconds, durationSeconds)++`]
...
[.contract-item]
[[VestingWalletCliff-constructor-uint64-]]
==== `[.contract-item-name]#++constructor++#++(uint64 cliffSeconds)++` [.item-kind]#internal#

Set the duration of the cliff, in seconds. The cliff starts vesting schedule (see {VestingWallet}'s
constructor) and ends `cliffSeconds` later.

[.contract-item]
[[VestingWalletCliff-cliff--]]
==== `[.contract-item-name]#++cliff++#++() → uint256++` [.item-kind]#public#

Getter for the cliff timestamp.

[.contract-item]
[[VestingWalletCliff-_vestingSchedule-uint256-uint64-]]
==== `[.contract-item-name]#++_vestingSchedule++#++(uint256 totalAllocation, uint64 timestamp) → uint256++` [.item-kind]#internal#
...
[.contract-item]
[[VestingWalletCliff-InvalidCliffDuration-uint64-uint64-]]
