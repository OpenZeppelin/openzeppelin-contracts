...
[.contract]
[[PaymentSplitter]]
=== `++PaymentSplitter++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.2/contracts/finance/PaymentSplitter.sol[{github-icon},role=heading-link]
...
[.contract]
[[VestingWallet]]
=== `++VestingWallet++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.2/contracts/finance/VestingWallet.sol[{github-icon},role=heading-link]
