...
:xref-ERC2771Forwarder-ERC2771ForwarderNoRefundReceiver--: xref:metatx.adoc#ERC2771Forwarder-ERC2771ForwarderNoRefundReceiver--
...
:xref-ERC2771Forwarder-FORWARD_REQUEST_TYPEHASH-bytes32: xref:metatx.adoc#ERC2771Forwarder-FORWARD_REQUEST_TYPEHASH-bytes32
:EIP712-constructor: pass:normal[xref:utils/cryptography.adoc#EIP712-constructor-string-string-[`EIP712.constructor`]]
:ECDSA-tryRecoverCalldata: pass:normal[xref:utils/cryptography.adoc#ECDSA-tryRecoverCalldata-bytes32-bytes-[`ECDSA.tryRecoverCalldata`]]
...
[.contract]
[[ERC2771Context]]
=== `++ERC2771Context++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/metatx/ERC2771Context.sol[{github-icon},role=heading-link]
...
Context variant with ERC-2771 support. See {_msgSender} for the calldata format.
...
:FORWARD_REQUEST_TYPEHASH: pass:normal[xref:#ERC2771Forwarder-FORWARD_REQUEST_TYPEHASH-bytes32[`++FORWARD_REQUEST_TYPEHASH++`]]
...
:ERC2771ForwarderNoRefundReceiver: pass:normal[xref:#ERC2771Forwarder-ERC2771ForwarderNoRefundReceiver--[`++ERC2771ForwarderNoRefundReceiver++`]]
...
[.contract]
[[ERC2771Forwarder]]
=== `++ERC2771Forwarder++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/metatx/ERC2771Forwarder.sol[{github-icon},role=heading-link]
...
.Errors
--
* {xref-ERC2771Forwarder-ERC2771ForwarderNoRefundReceiver--}[`++ERC2771ForwarderNoRefundReceiver()++`]
...
.Internal Variables
--
* {xref-ERC2771Forwarder-FORWARD_REQUEST_TYPEHASH-bytes32}[`++bytes32 constant FORWARD_REQUEST_TYPEHASH++`]
...
Batch version of {execute} with optional refunding.
...
[.contract-item]
[[ERC2771Forwarder-ERC2771ForwarderNoRefundReceiver--]]
==== `[.contract-item-name]#++ERC2771ForwarderNoRefundReceiver++#++()++` [.item-kind]#error#

A request in the batch failed and no `refundReceiver` was set to handle the leftover value.
...
[.contract-item]
[[ERC2771Forwarder-FORWARD_REQUEST_TYPEHASH-bytes32]]
==== `bytes32 [.contract-item-name]#++FORWARD_REQUEST_TYPEHASH++#` [.item-kind]#internal constant#
