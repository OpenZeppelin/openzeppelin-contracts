...
[.contract]
[[ERC2771Context]]
=== `++ERC2771Context++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.0/contracts/metatx/ERC2771Context.sol[{github-icon},role=heading-link]
...
[.contract]
[[ERC2771Forwarder]]
=== `++ERC2771Forwarder++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.6.0/contracts/metatx/ERC2771Forwarder.sol[{github-icon},role=heading-link]
