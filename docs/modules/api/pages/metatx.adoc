...
[.contract]
[[ERC2771Context]]
=== `++ERC2771Context++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.0/contracts/metatx/ERC2771Context.sol[{github-icon},role=heading-link]
...
[.contract]
[[MinimalForwarder]]
=== `++MinimalForwarder++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.0/contracts/metatx/MinimalForwarder.sol[{github-icon},role=heading-link]
