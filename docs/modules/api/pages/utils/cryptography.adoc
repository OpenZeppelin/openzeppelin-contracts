...
:TrieProof: pass:normal[xref:utils/cryptography.adoc#TrieProof[`TrieProof`]]
...
:xref-MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-: xref:utils/cryptography.adoc#MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-
:xref-MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-: xref:utils/cryptography.adoc#MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-
:xref-MessageHashUtils-toDomainTypeHash-bytes1-: xref:utils/cryptography.adoc#MessageHashUtils-toDomainTypeHash-bytes1-
:xref-MessageHashUtils-ERC5267ExtensionsNotSupported--: xref:utils/cryptography.adoc#MessageHashUtils-ERC5267ExtensionsNotSupported--
:ECDSA-recover: pass:normal[xref:utils/cryptography.adoc#ECDSA-recover-bytes32-uint8-bytes32-bytes32-[`ECDSA.recover`]]
:ECDSA-recover: pass:normal[xref:utils/cryptography.adoc#ECDSA-recover-bytes32-uint8-bytes32-bytes32-[`ECDSA.recover`]]
:ECDSA-recover: pass:normal[xref:utils/cryptography.adoc#ECDSA-recover-bytes32-uint8-bytes32-bytes32-[`ECDSA.recover`]]
:ECDSA-recover: pass:normal[xref:utils/cryptography.adoc#ECDSA-recover-bytes32-uint8-bytes32-bytes32-[`ECDSA.recover`]]
:IERC5267-eip712Domain: pass:normal[xref:interfaces.adoc#IERC5267-eip712Domain--[`IERC5267.eip712Domain`]]
...
:xref-SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-: xref:utils/cryptography.adoc#SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-
...
:xref-TrieProof-verify-bytes-bytes32-bytes-bytes---: xref:utils/cryptography.adoc#TrieProof-verify-bytes-bytes32-bytes-bytes---
:xref-TrieProof-traverse-bytes32-bytes-bytes---: xref:utils/cryptography.adoc#TrieProof-traverse-bytes32-bytes-bytes---
:xref-TrieProof-tryTraverse-bytes32-bytes-bytes---: xref:utils/cryptography.adoc#TrieProof-tryTraverse-bytes32-bytes-bytes---
:xref-TrieProof-TrieProofTraversalError-enum-TrieProof-ProofError-: xref:utils/cryptography.adoc#TrieProof-TrieProofTraversalError-enum-TrieProof-ProofError-
:xref-TrieProof-EVM_TREE_RADIX-uint256: xref:utils/cryptography.adoc#TrieProof-EVM_TREE_RADIX-uint256
:xref-TrieProof-BRANCH_NODE_LENGTH-uint256: xref:utils/cryptography.adoc#TrieProof-BRANCH_NODE_LENGTH-uint256
:xref-TrieProof-LEAF_OR_EXTENSION_NODE_LENGTH-uint256: xref:utils/cryptography.adoc#TrieProof-LEAF_OR_EXTENSION_NODE_LENGTH-uint256
...
:xref-SignerWebAuthn-_rawSignatureValidation-bytes32-bytes-: xref:utils/cryptography.adoc#SignerWebAuthn-_rawSignatureValidation-bytes32-bytes-
:xref-SignerP256-_setSigner-bytes32-bytes32-: xref:utils/cryptography.adoc#SignerP256-_setSigner-bytes32-bytes32-
:xref-SignerP256-signer--: xref:utils/cryptography.adoc#SignerP256-signer--
:xref-SignerP256-SignerP256InvalidPublicKey-bytes32-bytes32-: xref:utils/cryptography.adoc#SignerP256-SignerP256InvalidPublicKey-bytes32-bytes32-
:AbstractSigner: pass:normal[xref:utils/cryptography.adoc#AbstractSigner[`AbstractSigner`]]
...
:WebAuthn-WebAuthnAuth: pass:normal[xref:utils/cryptography.adoc#WebAuthn-WebAuthnAuth[`WebAuthn.WebAuthnAuth`]]
:WebAuthn-verify: pass:normal[xref:utils/cryptography.adoc#WebAuthn-verify-bytes-struct-WebAuthn-WebAuthnAuth-bytes32-bytes32-bool-[`WebAuthn.verify`]]
...
:xref-ERC7913WebAuthnVerifier-_requireUV--: xref:utils/cryptography.adoc#ERC7913WebAuthnVerifier-_requireUV--
= Cryptography
...
[.contract]
[[ECDSA]]
=== `++ECDSA++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/ECDSA.sol[{github-icon},role=heading-link]
...
:ERC5267ExtensionsNotSupported: pass:normal[xref:#MessageHashUtils-ERC5267ExtensionsNotSupported--[`++ERC5267ExtensionsNotSupported++`]]
...
:toDomainSeparator: pass:normal[xref:#MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-[`++toDomainSeparator++`]]
:toDomainSeparator: pass:normal[xref:#MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-[`++toDomainSeparator++`]]
:toDomainTypeHash: pass:normal[xref:#MessageHashUtils-toDomainTypeHash-bytes1-[`++toDomainTypeHash++`]]
...
:toDomainSeparator-bytes1-string-string-uint256-address-bytes32: pass:normal[xref:#MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-[`++toDomainSeparator++`]]
:toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32: pass:normal[xref:#MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-[`++toDomainSeparator++`]]
:toDomainTypeHash-bytes1: pass:normal[xref:#MessageHashUtils-toDomainTypeHash-bytes1-[`++toDomainTypeHash++`]]

[.contract]
[[MessageHashUtils]]
=== `++MessageHashUtils++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/MessageHashUtils.sol[{github-icon},role=heading-link]
...
* {xref-MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-}[`++toDomainSeparator(fields, name, version, chainId, verifyingContract, salt)++`]
* {xref-MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-}[`++toDomainSeparator(fields, nameHash, versionHash, chainId, verifyingContract, salt)++`]
* {xref-MessageHashUtils-toDomainTypeHash-bytes1-}[`++toDomainTypeHash(fields)++`]
...
.Errors
--
* {xref-MessageHashUtils-ERC5267ExtensionsNotSupported--}[`++ERC5267ExtensionsNotSupported()++`]
...
[.contract-item]
[[MessageHashUtils-toDomainSeparator-bytes1-string-string-uint256-address-bytes32-]]
==== `[.contract-item-name]#++toDomainSeparator++#++(bytes1 fields, string name, string version, uint256 chainId, address verifyingContract, bytes32 salt) → bytes32 hash++` [.item-kind]#internal#

Returns the EIP-712 domain separator constructed from an `eip712Domain`. See {IERC5267-eip712Domain}
...
[.contract-item]
[[MessageHashUtils-toDomainSeparator-bytes1-bytes32-bytes32-uint256-address-bytes32-]]
==== `[.contract-item-name]#++toDomainSeparator++#++(bytes1 fields, bytes32 nameHash, bytes32 versionHash, uint256 chainId, address verifyingContract, bytes32 salt) → bytes32 hash++` [.item-kind]#internal#

Variant of {toDomainSeparator-bytes1-string-string-uint256-address-bytes32} that uses hashed name and version.

[.contract-item]
[[MessageHashUtils-toDomainTypeHash-bytes1-]]
==== `[.contract-item-name]#++toDomainTypeHash++#++(bytes1 fields) → bytes32 hash++` [.item-kind]#internal#

Builds an EIP-712 domain type hash depending on the `fields` provided, following https://eips.ethereum.org/EIPS/eip-5267[ERC-5267]

[.contract-item]
[[MessageHashUtils-ERC5267ExtensionsNotSupported--]]
==== `[.contract-item-name]#++ERC5267ExtensionsNotSupported++#++()++` [.item-kind]#error#
...
[.contract]
[[P256]]
=== `++P256++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/P256.sol[{github-icon},role=heading-link]
...
[.contract]
[[RSA]]
=== `++RSA++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/RSA.sol[{github-icon},role=heading-link]
...
:isValidERC1271SignatureNowCalldata: pass:normal[xref:#SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-[`++isValidERC1271SignatureNowCalldata++`]]
...
:isValidERC1271SignatureNowCalldata-address-bytes32-bytes: pass:normal[xref:#SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-[`++isValidERC1271SignatureNowCalldata++`]]
...
[.contract]
[[SignatureChecker]]
=== `++SignatureChecker++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/SignatureChecker.sol[{github-icon},role=heading-link]
...
* {xref-SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-}[`++isValidERC1271SignatureNowCalldata(signer, hash, signature)++`]
...
[.contract-item]
[[SignatureChecker-isValidERC1271SignatureNowCalldata-address-bytes32-bytes-]]
==== `[.contract-item-name]#++isValidERC1271SignatureNowCalldata++#++(address signer, bytes32 hash, bytes signature) → bool result++` [.item-kind]#internal#
...
[.contract]
[[Hashes]]
=== `++Hashes++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/Hashes.sol[{github-icon},role=heading-link]
...
[.contract]
[[MerkleProof]]
=== `++MerkleProof++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/MerkleProof.sol[{github-icon},role=heading-link]
...
:Prefix: pass:normal[xref:#TrieProof-Prefix[`++Prefix++`]]
:ProofError: pass:normal[xref:#TrieProof-ProofError[`++ProofError++`]]
:TrieProofTraversalError: pass:normal[xref:#TrieProof-TrieProofTraversalError-enum-TrieProof-ProofError-[`++TrieProofTraversalError++`]]
:EVM_TREE_RADIX: pass:normal[xref:#TrieProof-EVM_TREE_RADIX-uint256[`++EVM_TREE_RADIX++`]]
:BRANCH_NODE_LENGTH: pass:normal[xref:#TrieProof-BRANCH_NODE_LENGTH-uint256[`++BRANCH_NODE_LENGTH++`]]
:LEAF_OR_EXTENSION_NODE_LENGTH: pass:normal[xref:#TrieProof-LEAF_OR_EXTENSION_NODE_LENGTH-uint256[`++LEAF_OR_EXTENSION_NODE_LENGTH++`]]
:verify: pass:normal[xref:#TrieProof-verify-bytes-bytes32-bytes-bytes---[`++verify++`]]
:traverse: pass:normal[xref:#TrieProof-traverse-bytes32-bytes-bytes---[`++traverse++`]]
:tryTraverse: pass:normal[xref:#TrieProof-tryTraverse-bytes32-bytes-bytes---[`++tryTraverse++`]]

:verify-bytes-bytes32-bytes-bytes--: pass:normal[xref:#TrieProof-verify-bytes-bytes32-bytes-bytes---[`++verify++`]]
:traverse-bytes32-bytes-bytes--: pass:normal[xref:#TrieProof-traverse-bytes32-bytes-bytes---[`++traverse++`]]
:tryTraverse-bytes32-bytes-bytes--: pass:normal[xref:#TrieProof-tryTraverse-bytes32-bytes-bytes---[`++tryTraverse++`]]

[.contract]
[[TrieProof]]
=== `++TrieProof++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/TrieProof.sol[{github-icon},role=heading-link]
...
.Functions
--
* {xref-TrieProof-verify-bytes-bytes32-bytes-bytes---}[`++verify(value, root, key, proof)++`]
* {xref-TrieProof-traverse-bytes32-bytes-bytes---}[`++traverse(root, key, proof)++`]
* {xref-TrieProof-tryTraverse-bytes32-bytes-bytes---}[`++tryTraverse(root, key, proof)++`]
...
.Errors
--
* {xref-TrieProof-TrieProofTraversalError-enum-TrieProof-ProofError-}[`++TrieProofTraversalError(err)++`]
...
.Internal Variables
--
* {xref-TrieProof-EVM_TREE_RADIX-uint256}[`++uint256 constant EVM_TREE_RADIX++`]
* {xref-TrieProof-BRANCH_NODE_LENGTH-uint256}[`++uint256 constant BRANCH_NODE_LENGTH++`]
* {xref-TrieProof-LEAF_OR_EXTENSION_NODE_LENGTH-uint256}[`++uint256 constant LEAF_OR_EXTENSION_NODE_LENGTH++`]

--

[.contract-item]
[[TrieProof-verify-bytes-bytes32-bytes-bytes---]]
==== `[.contract-item-name]#++verify++#++(bytes value, bytes32 root, bytes key, bytes[] proof) → bool++` [.item-kind]#internal#

Verifies a `proof` against a given `key`, `value`, and `root` hash.

[.contract-item]
[[TrieProof-traverse-bytes32-bytes-bytes---]]
==== `[.contract-item-name]#++traverse++#++(bytes32 root, bytes key, bytes[] proof) → bytes++` [.item-kind]#internal#
...
[.contract-item]
[[TrieProof-tryTraverse-bytes32-bytes-bytes---]]
==== `[.contract-item-name]#++tryTraverse++#++(bytes32 root, bytes key, bytes[] proof) → bytes value, enum TrieProof.ProofError err++` [.item-kind]#internal#
...
[.contract-item]
[[TrieProof-TrieProofTraversalError-enum-TrieProof-ProofError-]]
==== `[.contract-item-name]#++TrieProofTraversalError++#++(enum TrieProof.ProofError err)++` [.item-kind]#error#

[.contract-item]
[[TrieProof-EVM_TREE_RADIX-uint256]]
==== `uint256 [.contract-item-name]#++EVM_TREE_RADIX++#` [.item-kind]#internal constant#

The radix of the Ethereum trie

[.contract-item]
[[TrieProof-BRANCH_NODE_LENGTH-uint256]]
==== `uint256 [.contract-item-name]#++BRANCH_NODE_LENGTH++#` [.item-kind]#internal constant#

Number of items in a branch node (16 children + 1 value)

[.contract-item]
[[TrieProof-LEAF_OR_EXTENSION_NODE_LENGTH-uint256]]
==== `uint256 [.contract-item-name]#++LEAF_OR_EXTENSION_NODE_LENGTH++#` [.item-kind]#internal constant#

Number of items in leaf or extension nodes (always 2)
...
[.contract]
[[EIP712]]
=== `++EIP712++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/EIP712.sol[{github-icon},role=heading-link]
...
[.contract]
[[ERC7739Utils]]
=== `++ERC7739Utils++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/draft-ERC7739Utils.sol[{github-icon},role=heading-link]
...
[.contract]
[[WebAuthn]]
=== `++WebAuthn++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/WebAuthn.sol[{github-icon},role=heading-link]
...
[.contract]
[[AbstractSigner]]
=== `++AbstractSigner++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/AbstractSigner.sol[{github-icon},role=heading-link]
...
[.contract]
[[ERC7739]]
=== `++ERC7739++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/draft-ERC7739.sol[{github-icon},role=heading-link]
...
[.contract]
[[SignerECDSA]]
=== `++SignerECDSA++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerECDSA.sol[{github-icon},role=heading-link]
...
[.contract]
[[SignerP256]]
=== `++SignerP256++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerP256.sol[{github-icon},role=heading-link]
...
[.contract]
[[SignerRSA]]
=== `++SignerRSA++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerRSA.sol[{github-icon},role=heading-link]
...
[.contract]
[[SignerEIP7702]]
=== `++SignerEIP7702++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerEIP7702.sol[{github-icon},role=heading-link]
...
Implementation of {AbstractSigner} for implementation for an EOA. Useful for EIP-7702 accounts.
...
:_rawSignatureValidation-bytes32-bytes: pass:normal[xref:#SignerWebAuthn-_rawSignatureValidation-bytes32-bytes-[`++_rawSignatureValidation++`]]

[.contract]
[[SignerWebAuthn]]
=== `++SignerWebAuthn++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerWebAuthn.sol[{github-icon},role=heading-link]
...
.Functions
--
* {xref-SignerWebAuthn-_rawSignatureValidation-bytes32-bytes-}[`++_rawSignatureValidation(hash, signature)++`]
...
[.contract]
[[SignerERC7913]]
=== `++SignerERC7913++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/SignerERC7913.sol[{github-icon},role=heading-link]
...
[.contract]
[[MultiSignerERC7913]]
=== `++MultiSignerERC7913++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/MultiSignerERC7913.sol[{github-icon},role=heading-link]
...
=== `++MultiSignerERC7913Weighted++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/signers/MultiSignerERC7913Weighted.sol[{github-icon},role=heading-link]
...
[.contract]
[[ERC7913P256Verifier]]
=== `++ERC7913P256Verifier++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/verifiers/ERC7913P256Verifier.sol[{github-icon},role=heading-link]
...
[.contract]
[[ERC7913RSAVerifier]]
=== `++ERC7913RSAVerifier++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/verifiers/ERC7913RSAVerifier.sol[{github-icon},role=heading-link]
...
:_requireUV: pass:normal[xref:#ERC7913WebAuthnVerifier-_requireUV--[`++_requireUV++`]]
...
=== `++ERC7913WebAuthnVerifier++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.7.0/contracts/utils/cryptography/verifiers/ERC7913WebAuthnVerifier.sol[{github-icon},role=heading-link]
...
* {xref-ERC7913WebAuthnVerifier-_requireUV--}[`++_requireUV()++`]
...
[.contract-item]
[[ERC7913WebAuthnVerifier-_requireUV--]]
==== `[.contract-item-name]#++_requireUV++#++() → bool++` [.item-kind]#internal#
