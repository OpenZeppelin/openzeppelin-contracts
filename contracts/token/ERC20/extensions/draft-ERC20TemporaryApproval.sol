...
abstract contract ERC20TemporaryApproval is ERC20, IERC7674 {
    ...
    using StorageSlotTransient for bytes32;
    using StorageSlotTransient for StorageSlotTransient.Uint256SlotType;
    ...
    function _temporaryAllowanceSlot(
        address owner,
        address spender
    ) private pure returns (StorageSlotTransient.Uint256SlotType) {
