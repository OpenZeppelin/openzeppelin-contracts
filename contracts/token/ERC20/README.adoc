...
* {ERC3643}: institutional grade security token standard (T-REX) that provides compliance-driven token transfers with identity verification, freezing capabilities, and regulatory controls.
