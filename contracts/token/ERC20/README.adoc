...
* {IERC8255}: the ERC-20 extension for expiring approvals.
...
* {ERC20}: the implementation of the ERC-20 interface, including expiring approvals and the <<ERC20-name--,`name`>>, <<ERC20-symbol--,`symbol`>> and <<ERC20-decimals--,`decimals`>> optional extensions to the standard interface.
