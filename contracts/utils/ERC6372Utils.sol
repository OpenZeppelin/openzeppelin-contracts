...
// OpenZeppelin Contracts (last updated v5.7.0) (utils/ERC6372Utils.sol)
...
library ERC6372Utils {
    ...
    /// @dev Variant of {ERC6372Utils-blockNumberClockMode-uint48} that checks against an IERC6372 instance
    ...
    /// @dev Variant of {ERC6372Utils-blockNumberClockMode-uint48} that checks against the clock function.
    ...
    /// @dev Variant of {ERC6372Utils-timestampClockMode-uint48} that checks against an IERC6372 instance
    ...
    /// @dev Variant of {ERC6372Utils-timestampClockMode-uint48} that checks against the clock function.
