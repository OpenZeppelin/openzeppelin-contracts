...
library Counters {
     ...
     */
    function getAndIncrement(Counter storage counter) internal returns (uint256 value) {
        unchecked {
     ...
     */
    function incrementAndGet(Counter storage counter) internal returns (uint256 value) {
        unchecked {
            value = ++counter._value;
        }
    }
     ...
     */
    function getAndDecrement(Counter storage counter) internal returns (uint256 value) {
     ...
     */
    function decrementAndGet(Counter storage counter) internal returns (uint256 value) {
        require(counter._value > 0, "Counter: decrement overflow");
        unchecked {
            value = --counter._value;
        }
