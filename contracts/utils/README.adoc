 ...
 * {TransientReentrancyGuard}: Variant of {ReentrancyGuard} that uses transient storage (EIP-1153).
 ...
 * {TransientStorage}: Methods for reading and writing to transient storage.
