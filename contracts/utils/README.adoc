 ...
 * {MessageEnvelopeUtils}: A enveloped hashing scheme that prevents replayability of smart contract signatures leveraging EIP-712 typing.
 * {ERC1271TypedSigner}: A base contract to validate signatures using {MessageEnvelopeUtils}.
