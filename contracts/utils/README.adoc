 ...
 * {StorageSlot}: Methods for accessing specific storage slots formatted as common primitive types. Also include primitives for reading to and writting from transient storage (only value types are currently supported).
