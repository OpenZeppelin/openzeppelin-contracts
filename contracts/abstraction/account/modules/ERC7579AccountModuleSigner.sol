...
import {IERC7579Module, MODULE_TYPE_SIGNER} from "../../../interfaces/IERC7579Module.sol";
import {ERC7579Account} from "../ERC7579Account.sol";
import {EnumerableSet} from "../../../utils/structs/EnumerableSet.sol";

abstract contract ERC7579AccountModuleSigner is ERC7579Account {
    ...
    function supportsModule(uint256 moduleTypeId) public view virtual override returns (bool) {
        return moduleTypeId == MODULE_TYPE_SIGNER || super.supportsModule(moduleTypeId);
    }
    ...
    function _installModule(uint256 moduleTypeId, address module, bytes calldata initData) internal virtual override {
        if (moduleTypeId == MODULE_TYPE_SIGNER) {
    ...
    // TODO: do something with the signers?
    // TODO: enumerability?
}
