...
contract ERC7739ECDSAMock is ERC7739, SignerECDSA {
    constructor(address signerAddr) EIP712("ERC7739ECDSA", "1") SignerECDSA(signerAddr) {}
}

contract ERC7739P256Mock is ERC7739, SignerP256 {
    constructor(bytes32 qx, bytes32 qy) EIP712("ERC7739P256", "1") SignerP256(qx, qy) {}
}

contract ERC7739RSAMock is ERC7739, SignerRSA {
    constructor(bytes memory e, bytes memory n) EIP712("ERC7739RSA", "1") SignerRSA(e, n) {}
}
