...
contract MyTokenGovernance2 is ERC20, ERC20Permit, ERC20Votes, ERC20Wrapper {
    constructor(
        IERC20 wrappedToken
    ) ERC20("MyTokenGovernance2", "MTKG2") ERC20Permit("MyTokenGovernance2") ERC20Wrapper(wrappedToken) {}
