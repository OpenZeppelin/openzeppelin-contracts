...
* {GovernorStorage}: Stores the proposal detail onchain and provide enumerability of the proposals. This can be useful for some L2 chains where storage is cheap compared to calldata.
