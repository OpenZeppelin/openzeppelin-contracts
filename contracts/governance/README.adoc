...
** *Proposer:* An address (smart contract or EOA) that is in charge of scheduling (and cancelling) operations. Can be given to the zero address to allow anyone to act as a Proposer.
** *Executor:* An address (smart contract or EOA) that is in charge of executing operations. Can be given to the zero address to allow anyone to act as an Executor.
...
Proposer and Executor roles can be granted to the zero address to open them up and allow anyone to act as such a role.
