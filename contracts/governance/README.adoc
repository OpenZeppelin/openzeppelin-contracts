...
* {GovernorWeight}: Binding to extract voting weight from an {ERC20Votes} token.

* {GovernorWeightComp}: Binding to extract voting weight from a Comp or {ERC20VotesComp} token.
