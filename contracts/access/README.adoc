...
- {AccessManager} is a full-fledged role based access control solution smart contract systems. Allows creating and assigning multiple hierarchical roles with execution delays for each account across various contracts.
