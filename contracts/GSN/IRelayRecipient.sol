...
contract IRelayRecipient {
    ...
    /*
     * @dev Called by RelayHub to validate if this recipient accepts being charged for a relayed call. Note that the
     ...
     * replay attack protection in RelayHub, and `approvalData` is a optional field that can be used to hold a signature
    ...
    /*
     * @dev Called by RelayHub on approved relay call requests, before the relayed call is executed. This allows to e.g.
    ...
    /*
     * @dev Called by RelayHub on approved relay call requests, after the relayed call is executed. This allows to e.g.
