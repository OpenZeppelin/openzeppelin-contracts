...
for (const [ file, template ] of Object.entries({
  ...
  const content = format(
    ...
    `// This file was procedurally generated by \`${process.env._}\`. ` +
      `Any changes should be performed in the template file \`${path.join(path.dirname(process.env._), template)}\`.`,
