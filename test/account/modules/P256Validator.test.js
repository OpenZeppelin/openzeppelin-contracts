...
async function fixture() {
  ...
  const validator = await ethers.deployContract('$P256Validator');
  ...
  await erc7579Account.$_installModule(
    ...
    validator.target,
    ethers.AbiCoder.defaultAbiCoder().encode(['bytes32', 'bytes32'], [signer.publicKey.qx, signer.publicKey.qy]),
  );

  return { ...helper, target, signer, validator, erc7579Account, erc7579AccountAsSigner, domain };
}

describe('P256Validator', function () {
