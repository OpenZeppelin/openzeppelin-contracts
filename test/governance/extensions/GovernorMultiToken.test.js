...
const GovernorMultiToken = artifacts.require('GovernorMultiTokenMock');
...
contract('Governor', function (accounts) {
  ...
  const secondTokenName = 'SecondMockToken';
  const secondTokenSymbol = 'MTKN2';
  ...
  it('deployment check', async function () {
    ...
    expect(await this.mock.token()).to.be.equal(this.vault.address);
