  ...
  describe('burn', function () {
    ...
    describe('when the given amount is greater than the balance of the sender', function () {
      ...
      it('reverts', async function () {
        await shouldFail.reverting.withMessage(this.token.burn(amount, { from: owner }), "SafeMath: subtraction overflow");
      });
    });
  });
  ...
  describe('burnFrom', function () {
    ...
    describe('when the given amount is greater than the balance of the sender', function () {
      ...
      it('reverts', async function () {
        ...
        await shouldFail.reverting.withMessage(this.token.burnFrom(owner, amount, { from: burner }), "SafeMath: subtraction overflow");
      });
    });
    ...
    describe('when the given amount is greater than the allowance', function () {
      ...
      it('reverts', async function () {
        ...
        await shouldFail.reverting.withMessage(this.token.burnFrom(owner, allowance.addn(1), { from: burner }), "SafeMath: subtraction overflow");
      });
    });
  });
}
