...
const MintableERC827Token = artifacts.require('MintableERC827Token');

contract('MintableERC827Token', function ([owner, anotherAccount]) {
  beforeEach(async function () {
    this.token = await MintableERC827Token.new({ from: owner });
  });
