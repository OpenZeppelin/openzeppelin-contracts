...
var MintableERC827TokenMock = artifacts.require('MintableERC827TokenMock');
...
contract('Mintable ERC827 Token', function (accounts) {
  let token;
  ...
  beforeEach(async function () {
    token = await MintableERC827TokenMock.new(accounts[0], 100);
  });
  ...
  it('should return the correct allowance amount after approval', async function () {
    let token = await MintableERC827TokenMock.new(accounts[0], 100);
