    ...
    describe(`vote with ${mode}`, function () {
      ...
      describe('transfers', function () {
        ...
        it('sender delegation', async function () {
          ...
          const { receipt } = await this.votes.transferFrom(account1, account2, tokens[0], { from: account1 });
          expectEvent(receipt, 'Transfer', { from: account1, to: account2, tokenId: tokens[0] });
          expectEvent(receipt, 'DelegateVotesChanged', { delegate: account1, previousUnits: '1', newUnits: '0' });
        ...
        it('receiver delegation', async function () {
          ...
          const { receipt } = await this.votes.transferFrom(account1, account2, tokens[0], { from: account1 });
          expectEvent(receipt, 'Transfer', { from: account1, to: account2, tokenId: tokens[0] });
          expectEvent(receipt, 'DelegateVotesChanged', { delegate: account2, previousUnits: '0', newUnits: '1' });
