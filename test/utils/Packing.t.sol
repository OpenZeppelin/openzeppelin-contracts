...
contract PackingTest is Test {
    ...
    function testPack(bytes4 left, bytes6 right) external {
    ...
    function testPack(bytes6 left, bytes4 right) external {
    ...
    function testPack(bytes12 left, bytes10 right) external {
    ...
    function testPack(bytes16 left, bytes6 right) external {
    ...
    function testPack(bytes20 left, bytes2 right) external {
    ...
    function testReplace(bytes10 container, bytes1 newValue, uint8 offset) external {
    ...
    function testReplace(bytes10 container, bytes2 newValue, uint8 offset) external {
    ...
    function testReplace(bytes10 container, bytes4 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 6));
    ...
    function testReplace(bytes10 container, bytes6 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 4));
    ...
    function testReplace(bytes10 container, bytes8 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 2));
    ...
    function testReplace(bytes12 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 2));
    ...
    function testReplace(bytes16 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 6));
    ...
    function testReplace(bytes20 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 10));
    ...
    function testReplace(bytes22 container, bytes1 newValue, uint8 offset) external {
    ...
    function testReplace(bytes22 container, bytes2 newValue, uint8 offset) external {
    ...
    function testReplace(bytes22 container, bytes4 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 18));
    ...
    function testReplace(bytes22 container, bytes6 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 16));
    ...
    function testReplace(bytes22 container, bytes8 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 14));
    ...
    function testReplace(bytes22 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 12));
    ...
    function testReplace(bytes22 container, bytes12 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 10));
    ...
    function testReplace(bytes22 container, bytes16 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 6));
    ...
    function testReplace(bytes22 container, bytes20 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 2));
    ...
    function testReplace(bytes24 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 14));
    ...
    function testReplace(bytes24 container, bytes22 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 2));
    ...
    function testReplace(bytes28 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 18));
    ...
    function testReplace(bytes28 container, bytes22 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 6));
    ...
    function testReplace(bytes32 container, bytes10 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 22));
    ...
    function testReplace(bytes32 container, bytes22 newValue, uint8 offset) external {
        offset = uint8(bound(offset, 0, 10));
