...
const ERC165Storage = artifacts.require('XERC165Storage');
...
contract('ERC165Storage', function (accounts) {
  ...
  it('register interface', async function () {
    ...
    await this.mock.x_registerInterface('0x00000001');
    expect(await this.mock.supportsInterface('0x00000001')).to.be.equal(true);
  });

  it('does not allow 0xffffffff', async function () {
    await expectRevert(this.mock.x_registerInterface('0xffffffff'), 'ERC165: invalid interface id');
  });
