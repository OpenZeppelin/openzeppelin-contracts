...
const ERC165CheckerMock = load.truffle('ERC165CheckerMock');
const ERC165NotSupported = load.truffle('ERC165NotSupported');
const ERC165InterfacesSupported = load.truffle('ERC165InterfacesSupported');
