...
module.exports = function shouldBehaveLikeAdminBeaconUpgradeableProxy (createBeacon, createProxyWithAdmin, accounts) {
    ...
    describe('when the sender is the admin', function () {
      ...
      describe('when the given implementation is different from the current one', function () {
        it('upgrades to the requested implementation', async function () {
          const beacon = await createBeacon(this.implementationV1, { from });
      ...
      describe('when the sender is the admin', function () {
        ...
        describe('when upgrading to V1', function () {
          ...
          beforeEach(async function () {
            ...
            this.balancePrevious_v1 = new BN(await web3.eth.getBalance(this.proxyAddress));
          ...
          describe('when upgrading to V2', function () {
            ...
            beforeEach(async function () {
              ...
              this.balancePrevious_v2 = new BN(await web3.eth.getBalance(this.proxyAddress));
            ...
            describe('when upgrading to V3', function () {
              ...
              beforeEach(async function () {
                ...
                this.balancePrevious_v3 = new BN(await web3.eth.getBalance(this.proxyAddress));
