...
contract('SplitPayment', function ([_, owner, payee1, payee2, payee3, nonpayee1, payer1]) {
  ...
  context('once deployed', function () {
    ...
    it('should throw if no funds to claim', async function () {
      await expectThrow(this.contract.claim(payee1), EVMRevert);
    });

    it('should throw if non-payee want to claim', async function () {
      await ethSendTransaction({ from: payer1, to: this.contract.address, value: amount });
      await expectThrow(this.contract.claim(nonpayee1), EVMRevert);
    });
    ...
    it('should distribute funds to payees', async function () {
      ...
      await this.contract.claim(payee1);
      ...
      await this.contract.claim(payee2);
      ...
      await this.contract.claim(payee3);
