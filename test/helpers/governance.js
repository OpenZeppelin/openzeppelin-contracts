...
class GovernorHelperBigInt {
  ...
  connect(account) {
    return new GovernorHelperBigInt(this.governor.connect(account), this.mode, this.currentProposal);
  }
  ...
  setProposal(actions, description) {
    ...
    return new GovernorHelperBigInt(this.governor, this.mode, currentProposal);
  }
}
