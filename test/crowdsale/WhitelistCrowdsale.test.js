...
const WhitelistCrowdsale = load.truffle('WhitelistCrowdsaleImpl');
const SimpleToken = load.truffle('SimpleToken');

describe('WhitelistCrowdsale', function ([_, wallet, whitelister, whitelisted, otherWhitelisted, other]) {
  const rate = new BN(1);
